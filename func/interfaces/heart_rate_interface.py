...
class HeartRateInterface(QWidget):
    ...
    def setup_ui(self):
        ...
        # 清空所有内容，只显示"456"
        self.dashboard_label = QLabel("456")
        self.dashboard_label.setStyleSheet("font-family: 'Segoe UI'; font-size: 48px; font-weight: bold; color: #333;")
        self.dashboard_label.setAlignment(Qt.AlignCenter)
        
        # 添加到卡片布局，居中显示
        self.dashboard_card_layout.addStretch()
        self.dashboard_card_layout.addWidget(self.dashboard_label)
        self.dashboard_card_layout.addStretch()
